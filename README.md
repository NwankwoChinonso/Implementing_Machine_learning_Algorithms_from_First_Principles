...
## 📓 Notebook Structure
1.  **Theory:** Mathematical explanation with equations (using $\LaTeX$).
2.  **Implementation:** Building algorithms from scratch using NumPy [1].
3.  **Visualization:** Plotting results using Matplotlib/Seaborn.
...
---
*Created as part of my journey to deeply understand the "why" behind the "how" in Machine Learning.*
